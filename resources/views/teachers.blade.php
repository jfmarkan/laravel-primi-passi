    ...
    <div class="container">
        <div class="row">
            <div class="col text-center">
                <h1>BOOLEAN Classe #98 - Teachers</h1>
            </div>
        </div>
        <div class="row">
            <div class="col">
        ...
        @foreach ($teachers as $teacher)
            <div class="col-3 mt-4">
                <div class="card">
                    <img src="{{ $teacher['img'] }}" class="card-img-top" alt="{{ $teacher['name'] }}'s Picture" style="max-height:304px; object-fit:cover;">
                    <div class="card-body">
                        <h4 class="card-text text-center fw-bold">{{ $teacher['name'] }} {{ $teacher['surname'] }}</h4>
                        <p class="card-text text-center">{{ $teacher['role'] }}</p>
                    </div>
                </div>
            </div>
        @endforeach
